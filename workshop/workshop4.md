# S-DOEA - Workshop 4.5 - Infrastructure as Code Workshop (Puppet)

## Pre-requisite
* AWS Account 
* Jupyter Notebbok Password will be provided during class
* Access to this url (Jump host) : [http://159.223.95.85:8888/tree?token=0cadc22a6dc9ff20462b6dee0d749135c6e8dd1693d40fc4](http://159.223.95.85:8888/tree?token=0cadc22a6dc9ff20462b6dee0d749135c6e8dd1693d40fc4)
...
7.	Select the security group that you have created earlier on for both of the instances. Add two custom rules to the security group port 80 (HTTP) and 8140 (TCP). Port 8140 is being used for the master and slave synchronization.
